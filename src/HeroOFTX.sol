...
import {IHeroOFTX} from "/interfaces/IHeroOFTX.sol";
...
abstract contract HeroOFTX is IHeroOFTX, HeroOFTXCallbacks, OApp, HeroOFTErrors {
    ...
    function _estimateFee(uint32 _dstEid, bytes memory _message, bytes memory _options) internal view returns (MessagingFee memory fee_) {
