...
import {OFT20Ticker, ERC20} from "/OFT20Ticker.sol";
...
contract HeroLinearToken20 is OFT20Ticker {
    ...
    function _onValidatorCrossChain(address) internal override returns (uint256 tokenIdOrAmount_, uint256 totalMinted_, bool success_) {
