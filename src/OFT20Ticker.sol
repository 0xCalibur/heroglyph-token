...
import {HeroOFTXOperator} from "/HeroOFTXOperator.sol";
...
abstract contract OFT20Ticker is BaseOFT20, HeroOFTXOperator {
    ...
    function _debit(uint256 _amountIn, uint256 _minAmountOut) internal virtual override returns (uint256 amountReceiving_) {
